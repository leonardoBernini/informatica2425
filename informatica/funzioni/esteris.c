...
int main(){
    ...
    do{
        ...
        switch(opzione){
            case 1: if(a1 == ' ') a1 = simbolo; break;
            case 2: if(a2 == ' ') a2 = simbolo; break;
            case 3: if(a3 == ' ') a3 = simbolo; break;
            case 4: if(b1 == ' ') b1 = simbolo; break;
            case 5: if(b2 == ' ') b2 = simbolo; break;
            case 6: if(b3 == ' ') b3 = simbolo; break;
            case 7: if(c1 == ' ') c1 = simbolo; break;
            case 8: if(c2 == ' ') c2 = simbolo; break;
            case 9: if(c3 == ' ') c3 = simbolo; break;
